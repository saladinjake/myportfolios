export const myData = [
  {
    ...
    linkedIn: 'https://www.linkedin.com/m/in/victor-dibs-462252b9',
    portofolioWeb: 'https://victorjuwa.vercel.app',
    lastProject: 'https://pacemaker.herokuapp.com/',
    ...
    technologys: {
      ...
      backEnd: ['NodeJS / Mongoose / Expressjs / MongoDB / MySQL / POSTGRES/PHP/LARAVEL/DJANGO'],
      frameWorkes: ['Reactjs / Nextjs / Redux / Angular / Vue / Vuex'],
      sourseControl: ['Git / GitHub / BitBucket'],
...
export const projects = [
  ...
  },
  {
    title: 'Pacemaker',
    description:
      "While building it you're going to learn many advanced React & JavaScript topics ",
  ...
  },
  {
    title: 'Ecommerce',
    description:
      "This is a code repository for the corresponding YouTube video.",
...
export const TimeLineData = [
  { year: 2018, text: 'Worked as a freelance' },
  { year: 2019, text: 'First time frontend role' },
  { year: 2020, text: 'Frontend team leader' },
  { year: 2021, text: 'Worked on personal projects' },

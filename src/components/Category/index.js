...
import { DropDownContainer, DropDownIcon, DropDownItem, DropDownItemDesc, DropDownItemTitle, DropDownTextContainer } from './CategoryStyles'
  ...
  <DropDownContainer active={props.isOpen}>
    ...
    <DropDownItem href="#" target="_blank" rel="noreferrer">
      ...
      <DropDownTextContainer>
        ...
        <DropDownItemDesc>My Address</DropDownItemDesc>
      </DropDownTextContainer>
    </DropDownItem>
  </DropDownContainer>
);
